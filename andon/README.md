...
| [`tools/instalar.ps1`](../tools/instalar.ps1) + [`probar-instalador.ps1`](../tools/probar-instalador.ps1) | El **instalador** (Sprint 3, MVP Windows-first, ADR 0008): siembra el método en un repo destino leyendo el motor genérico del árbol (sin duplicar la ley), regla **no-clobber**. Su smoke instala en un repo temporal y corre los self-tests sembrados — un instalador que siembra un motor roto se caza ahí. |
