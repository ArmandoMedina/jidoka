...
- **Copias la plantilla** que corresponde y la llenas — **nunca redactas de cero**. Las plantillas viven en `kit/.jidoka/templates/` (ADR, sprint-plan, sprint-entrega, plan-de-trabajo, infra, PRODUCT_BRIEF). Copiar la plantilla evita que cada documento reinvente su forma y que el grafo drifte.
