...
Esta guía te lleva de la mano, sin asumir nada, desde `npx jidoka-method init` hasta tu primer sprint entregado con demo visual.

## Lo que cubrirá

1. **Instalar** — `npx jidoka-method init`, elegir tu arquetipo (code-first · docs-as-code · doc-only) y stack.
