...
| [Conciencia del agente — reconstrucción limpia](sprint-conciencia-del-agente-plan.md) | Agentes-asiento tiereados (#63, ADR 0033), reframe rol-teatro + payload inyecta-directo en `arranca` (ADR 0034), split `PRODUCT_BRIEF.md`/`infra.md` (#75) | En construcción |
