...
foreach ($t in @('probar-version','probar-gate','probar-hooks','probar-auditor','probar-disparos','probar-preflight','probar-docs','probar-linterna','probar-anti-pii','probar-instalador','probar-sembrar','probar-agentes')) {
