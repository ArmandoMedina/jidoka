...
foreach ($t in @('probar-version','probar-gate','probar-hooks','probar-auditor','probar-disparos','probar-preflight','probar-docs','probar-ligas','probar-linterna','probar-bandeja','probar-ritual','probar-anti-pii','probar-instalador','probar-sembrar','probar-agentes','probar-extension','probar-app')) {
