...
foreach ($t in @('probar-version','probar-gate','probar-hooks','probar-auditor','probar-disparos','probar-adrs','probar-preflight','probar-docs','probar-flujo','probar-ligas','probar-linterna','probar-bandeja','probar-ritual','probar-parametrizar','probar-override','probar-anti-pii','probar-instalador','probar-sembrar','probar-agentes','probar-app')) {
