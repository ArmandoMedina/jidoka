...
- [x] ~~Publicar el release `v0.2.0-beta`~~ — publicado con autorización nombrada del cliente (2026-07-10): <https://github.com/ArmandoMedina/jidoka/releases/tag/v0.2.0-beta>.
