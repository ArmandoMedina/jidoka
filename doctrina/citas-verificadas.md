...
| 9 | Airbus fly-by-wire: límites duros del envelope (`deny`), el piloto no puede anular | **VERIFICADO (matiz)** (2026-07-11) | Válido en **Normal Law** (protecciones de envelope completas). Bajo fallas el avión degrada a **Alternate Law** (protecciones reducidas/perdidas según la falla) o **Direct Law** (sin protecciones; stick→superficie directo) — ahí el piloto **sí** puede exceder el envelope. La 'dureza' del `deny` es **condicional al modo**; usar la analogía sin ese matiz sobre-vende la garantía. Reflejado en `03-aviacion.md` |
