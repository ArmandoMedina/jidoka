...
1. **El GIF del gate mordiendo — la pieza más valiosa de toda la vitrina.** El guion completo, copy-paste y con limpieza incluida, quedó preparado en [`docs/guias/guion-gif-del-gate.md`](docs/guias/guion-gif-del-gate.md) (sesión 2026-07-11); solo falta la grabación humana (~20 s con ScreenToGif). Destino: README → sección *Velo bloquear un cambio malo* (el comentario HTML ya marca el lugar, arriba del texto).
